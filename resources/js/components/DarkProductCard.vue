<template>
    <div class="relative overflow-hidden rounded-2xl bg-neutral-800 border border-neutral-700
        ...
        <!-- Main Product Image -->
        <Link v-if="product.slug" :href="route('products.show', product.slug)"
        ...
        <div class="bg-neutral-800 text-white px-4 pt-4 pb-6 rounded-t-3xl">
            ...
            <div class="flex items-center justify-between gap-2">
                ...
                <!-- Wishlist -->
                <button @click="liked = !liked" class="bg-neutral-700 p-3 rounded-xl transition hover:bg-neutral-600">
...
const discountedPrice = computed(() => props.product.discountedPrice)
...
function onAddToCart() {
    shop.addToCart({
        id: props.product.id,
        name: props.product.name,
        price: discountedPrice.value || price.value,
        image: mainImage.value,
    })
}
</script>
