    ...
    <AuthLayout title="Reset password" description="Please enter your new password below">
        ...
        <Form v-bind="update.form()" :transform="(data) => ({ ...data, token, email })"
            ...
            <div class="grid gap-6">
                ...
                <PasswordInput id="password_confirmation" name="password_confirmation" label="Confirm Password"
                    autocomplete="current-password" placeholder="Confirm password" :tabindex="2"
